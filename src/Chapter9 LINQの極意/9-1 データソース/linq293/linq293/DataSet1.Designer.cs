...
namespace linq293 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class 商品DataTable : global::System.Data.TypedTableBase<商品Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public 商品Row Add商品Row(int Id, string 分類, string 商品名, int 単価, int 数量) {
            ...
            private void InitClass() {
                ...
                this.column分類.AllowDBNull = false;
                this.column分類.MaxLength = 50;
        ...
        public partial class 商品Row : global::System.Data.DataRow {
            ...
            public int Id {
                get {
                    return ((int)(this[this.table商品.IdColumn]));
                }
                set {
                    this[this.table商品.IdColumn] = value;
                }
            }
            ...
            public string 分類 {
                get {
                    return ((string)(this[this.table商品.分類Column]));
                }
                set {
                    this[this.table商品.分類Column] = value;
                }
            }
            ...
            public int 単価 {
                get {
                    return ((int)(this[this.table商品.単価Column]));
                }
                set {
                    this[this.table商品.単価Column] = value;
                }
            }
            ...
            public int 数量 {
                get {
                    return ((int)(this[this.table商品.数量Column]));
                }
                set {
                    this[this.table商品.数量Column] = value;
                }
            }
        }
...
namespace linq293.DataSet1TableAdapters {
    ...
    public partial class 商品TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[商品] WHERE (([Id] = @Original_Id) AND ([分類] = @Original_分類) AND" +
                " ([商品名] = @Original_商品名) AND ([単価] = @Original_単価) AND ([数量] = @Original_数量))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_単価", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "単価", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[商品] ([Id], [分類], [商品名], [単価], [数量]) VALUES (@Id, @分類, @商品名, @単" +
                "価, @数量);\r\nSELECT Id, 分類, 商品名, 単価, 数量 FROM 商品 WHERE (Id = @Id)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@単価", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "単価", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[商品] SET [Id] = @Id, [分類] = @分類, [商品名] = @商品名, [単価] = @単価, [数量] = @数量 WHERE (([Id] = @Original_Id) AND ([分類] = @Original_分類) AND ([商品名] = @Original_商品名) AND ([単価] = @Original_単価) AND ([数量] = @Original_数量));
SELECT Id, 分類, 商品名, 単価, 数量 FROM 商品 WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@単価", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "単価", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_単価", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "単価", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::linq293.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, 分類, 商品名, 単価, 数量 FROM dbo.商品";
        ...
        public virtual int Fill(DataSet1.商品DataTable dataTable) {
        ...
        public virtual DataSet1.商品DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet1.商品DataTable dataTable = new DataSet1.商品DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1.商品DataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_分類, string Original_商品名, int Original_単価, int Original_数量) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            if ((Original_分類 == null)) {
                throw new global::System.ArgumentNullException("Original_分類");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_分類));
            }
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_単価));
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_数量));
        ...
        public virtual int Insert(int Id, string 分類, string 商品名, int 単価, int 数量) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Id));
            if ((分類 == null)) {
                throw new global::System.ArgumentNullException("分類");
            }
            else {
                this.Adapter.InsertCommand.Parameters[1].Value = ((string)(分類));
            }
            if ((商品名 == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(単価));
        ...
        public virtual int Update(int Id, string 分類, string 商品名, int 単価, int 数量, int Original_Id, string Original_分類, string Original_商品名, int Original_単価, int Original_数量) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Id));
            if ((分類 == null)) {
                throw new global::System.ArgumentNullException("分類");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(分類));
            }
            if ((商品名 == null)) {
                throw new global::System.ArgumentNullException("商品名");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(単価));
            ...
            if ((Original_分類 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_分類));
            }
            if ((Original_商品名 == null)) {
                throw new global::System.ArgumentNullException("Original_商品名");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_単価));
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_数量));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string 分類, string 商品名, int 単価, int 数量, int Original_Id, string Original_分類, string Original_商品名, int Original_単価, int Original_数量) {
            return this.Update(Original_Id, 分類, 商品名, 単価, 数量, Original_Id, Original_分類, Original_商品名, Original_単価, Original_数量);
        }
    }
