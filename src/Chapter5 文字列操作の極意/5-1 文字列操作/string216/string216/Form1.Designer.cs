namespace string216
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label5.Text = "テキストボックスの文字列の前後の空白を削除します。";
            // 
            // button1
            // 
            ...
            this.button1.Text = "文字列の前後のスペースを削除する";
