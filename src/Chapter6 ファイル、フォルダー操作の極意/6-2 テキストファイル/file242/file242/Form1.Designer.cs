namespace file242
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.listBox1.Size = new System.Drawing.Size(285, 64);
            ...
            this.label5.Text = "テキストボックスに入力されたパスのファイルから1行ずつ読み取って表示し、ファイルの最後に達したら処理を終了します。";
            // 
            // button1
            // 
            ...
            this.button1.Text = "ファイルの末尾かどうか取得する";
