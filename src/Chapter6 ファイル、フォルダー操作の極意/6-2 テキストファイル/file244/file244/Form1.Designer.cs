namespace file244
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label5.Text = "ファイルパステキストボックスのファイルの末尾に、出力文字列テキストボックスの文字列を追加します。";
            // 
            // button2
            // 
            ...
            this.button2.Text = "シフトJISコードでテキストファイルの末尾に書き込む";
            ...
            this.button1.Text = "UTFエンコードでテキストファイルの末尾に書き込む";
